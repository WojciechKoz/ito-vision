...
class DDIMSampler(Sampler):
    def __init__(self, N: int = 30, sigma: Optional[Callable] = None, quiet: bool = False):
        super().__init__(N, quiet)
        self.sigma = sigma if sigma is not None else lambda t: torch.zeros_like(t)  # deterministic DDIM by default
    ...
    def __iter__(
        ...
        **kwargs: Any,
        ...
        for t, dt in zip(ts[:-1], dts):
            ...
            x = self.sample_from_DDIM(method, x, pred_x0, y, t + dt, t)
